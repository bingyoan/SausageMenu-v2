...
const HOME_COPY: Partial<Record<TargetLanguage, HomeCopy>> = {
  [TargetLanguage.ChineseTW]: {
    ...
    totalPaidUsers: '付費用戶總人數', notificationsComingSoon: '通知功能即將推出', menu: '選單', settings: '設定', help: '操作教學',
  ...
  [TargetLanguage.English]: {
    ...
    totalPaidUsers: 'Total paying users', notificationsComingSoon: 'Notifications are coming soon', menu: 'Menu', settings: 'Settings', help: 'How to use',
  ...
  [TargetLanguage.Japanese]: {
    ...
    totalPaidUsers: '有料ユーザー総数', notificationsComingSoon: '通知機能は近日公開', menu: 'メニュー', settings: '設定', help: '使い方',
  ...
  [TargetLanguage.Korean]: {
    ...
    totalPaidUsers: '총 유료 사용자', notificationsComingSoon: '알림 기능 준비 중', menu: '메뉴', settings: '설정', help: '사용 방법',
  ...
  [TargetLanguage.Thai]: {
    ...
    totalPaidUsers: 'ผู้ใช้ที่ชำระเงินทั้งหมด', notificationsComingSoon: 'ฟีเจอร์แจ้งเตือนเร็ว ๆ นี้', menu: 'เมนู', settings: 'การตั้งค่า', help: 'วิธีใช้งาน',
  ...
  [TargetLanguage.Vietnamese]: {
    ...
    totalPaidUsers: 'Tổng người dùng trả phí', notificationsComingSoon: 'Tính năng thông báo sắp ra mắt', menu: 'Menu', settings: 'Cài đặt', help: 'Hướng dẫn sử dụng',
  ...
  [TargetLanguage.Indonesian]: {
    ...
    totalPaidUsers: 'Total pengguna berbayar', notificationsComingSoon: 'Fitur notifikasi segera hadir', menu: 'Menu', settings: 'Pengaturan', help: 'Panduan penggunaan',
  ...
  [TargetLanguage.French]: {
    ...
    totalPaidUsers: 'Total des utilisateurs payants', notificationsComingSoon: 'Les notifications arrivent bientôt', menu: 'Menu', settings: 'Paramètres', help: 'Guide d’utilisation',
  ...
  [TargetLanguage.Spanish]: {
    ...
    totalPaidUsers: 'Total de usuarios de pago', notificationsComingSoon: 'Las notificaciones estarán disponibles pronto', menu: 'Menú', settings: 'Ajustes', help: 'Guía de uso',
  ...
  [TargetLanguage.Filipino]: {
    ...
    totalPaidUsers: 'Kabuuang nagbayad na user', notificationsComingSoon: 'Malapit nang ilunsad ang mga notification', menu: 'Menu', settings: 'Mga Setting', help: 'Gabay sa paggamit',
  ...
  [TargetLanguage.German]: {
    ...
    totalPaidUsers: 'Zahlende Nutzer insgesamt', notificationsComingSoon: 'Benachrichtigungen folgen in Kürze', menu: 'Menü', settings: 'Einstellungen', help: 'Anleitung',
  ...
  [TargetLanguage.Russian]: {
    ...
    totalPaidUsers: 'Всего платящих пользователей', notificationsComingSoon: 'Уведомления скоро появятся', menu: 'Меню', settings: 'Настройки', help: 'Руководство',
  ...
  [TargetLanguage.Polish]: {
    ...
    totalPaidUsers: 'Łączna liczba płacących użytkowników', notificationsComingSoon: 'Powiadomienia już wkrótce', menu: 'Menu', settings: 'Ustawienia', help: 'Instrukcja',
  ...
  [TargetLanguage.Malay]: {
    ...
    totalPaidUsers: 'Jumlah pengguna berbayar', notificationsComingSoon: 'Ciri pemberitahuan akan datang', menu: 'Menu', settings: 'Tetapan', help: 'Panduan penggunaan',
  ...
  [TargetLanguage.Italian]: {
    ...
    totalPaidUsers: 'Totale utenti paganti', notificationsComingSoon: 'Le notifiche arriveranno presto', menu: 'Menu', settings: 'Impostazioni', help: 'Guida',
  ...
  [TargetLanguage.Portuguese]: {
    ...
    totalPaidUsers: 'Total de usuários pagantes', notificationsComingSoon: 'As notificações estarão disponíveis em breve', menu: 'Menu', settings: 'Definições', help: 'Guia de utilização',
