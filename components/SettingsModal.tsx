...
const TRANSLATIONS: Record<string, any> = {
  ...
  '한국어': {
    ...
    apiTitle: '고급: 개인 API 키 (선택)',
    apiHint: '일반 사용자는 입력할 필요가 없습니다. 앱의 기본 AI 서비스를 사용하며, 개인 할당량을 사용할 때만 입력하세요. 비워 두면 기본 서비스로 돌아갑니다.',
    apiLink: 'Google AI Studio에서 개인 키 받기',
