...
const TRANSLATIONS: Record<string, {
  ...
  'English': {
    ...
    errorFormat: "Invalid format. API Keys usually start with 'AIza' or 'AQ'.",
    ...
    tutorialSteps: [
      ...
      'Copy the generated key (starts with AIza or AQ) and paste it above',
    ],
  ...
  '한국어': {
    ...
    errorFormat: '잘못된 형식. API 키는 \'AIza\' 또는 \'AQ\'로 시작합니다.',
    ...
    tutorialSteps: [
      ...
      '생성된 Key (AIza 또는 AQ로 시작)를 복사하여 위에 붙여넣기',
    ],
  ...
  'Français': {
    ...
    errorFormat: 'Format invalide. Les clés commencent par \'AIza\' ou \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Copiez la clé (commence par AIza ou AQ) et collez ci-dessus',
    ],
  ...
  'Español': {
    ...
    errorFormat: 'Formato inválido. Comienza con \'AIza\' o \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Copia la clave (empieza con AIza o AQ) y pégala arriba',
    ],
  ...
  'ไทย': {
    ...
    errorFormat: 'รูปแบบไม่ถูกต้อง ต้องขึ้นต้นด้วย \'AIza\' หรือ \'AQ\'',
    ...
    tutorialSteps: [
      ...
      'คัดลอก Key (ขึ้นต้นด้วย AIza หรือ AQ) แล้ววางในช่องด้านบน',
    ],
  ...
  'Tiếng Việt': {
    ...
    errorFormat: 'Định dạng không hợp lệ. Bắt đầu bằng \'AIza\' hoặc \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Sao chép Key (bắt đầu bằng AIza hoặc AQ) và dán vào ô phía trên',
    ],
  ...
  'Deutsch': {
    ...
    errorFormat: 'Ungültiges Format. Beginnt mit \'AIza\' oder \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Key kopieren (beginnt mit AIza oder AQ) und oben einfügen',
    ],
  ...
  'Русский': {
    ...
    errorFormat: 'Неверный формат. Начинается с \'AIza\' или \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Скопируйте ключ (начинается с AIza или AQ) и вставьте выше',
    ],
  ...
  'Tagalog': {
    ...
    errorFormat: 'Di-wastong format. Nagsisimula sa \'AIza\' o \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Kopyahin ang Key (nagsisimula sa AIza o AQ) at i-paste sa itaas',
    ],
  ...
  'Bahasa Indonesia': {
    ...
    errorFormat: 'Format tidak valid. Dimulai dengan \'AIza\' atau \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Salin Key (dimulai AIza atau AQ) dan tempel di kolom atas',
    ],
  ...
  'Polski': {
    ...
    errorFormat: 'Nieprawidłowy format. Zaczyna się od \'AIza\' lub \'AQ\'.',
    ...
    tutorialSteps: [
      ...
      'Skopiuj klucz (zaczyna się od AIza lub AQ) i wklej powyżej',
    ],
  ...
  'Italiano': {
    ...
    errorFormat: "Formato non valido. Le chiavi API di solito iniziano con 'AIza' o 'AQ'.",
    ...
    tutorialSteps: [
      ...
      'Copia la chiave generata (inizia con AIza o AQ) e incollala qui sopra',
    ],
  ...
  'Português': {
    ...
    errorFormat: "Formato inválido. Chaves API geralmente começam com 'AIza' ou 'AQ'.",
    ...
    tutorialSteps: [
      ...
      'Copie a chave gerada (começa com AIza ou AQ) e cole-a acima',
    ],
